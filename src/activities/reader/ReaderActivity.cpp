...
void ReaderActivity::onGoToMusicReader(const std::string& path) {
  currentBookPath = path;
  activityManager.replaceActivity(std::make_unique<MusicReaderActivity>(renderer, mappedInput, path));
}
